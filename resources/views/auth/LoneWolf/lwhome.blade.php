        ...
        <div id="carousel-example-generic" class="carousel slide navcustom gap" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="img-responsive center-block" src="/images/Banner3.jpg" alt="..." width="734px" height="auto">
                <div class="carousel-caption">
                    ...
                </div>
                </div>
                <div class="item">
                    <img class="img-responsive center-block" src="/images/Banner2.jpg" width="700px" height="auto">
                <div class="carousel-caption">
                    ...
                </div>
                </div>
                <div class="item">
                    <img class="img-responsive center-block" src="/images/Banner.jpg" width="700px" height="auto">
                <div class="carousel-caption">
                    ...
                </div>
                </div>
